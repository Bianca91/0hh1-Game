...
describe("rows and cols", () => {
  const board = [[1, 2, 1, 2], [1, 1, 2, 2], [2, 2, 1, 1], [2, 1, 2, 1]];

  const columns = [[1, 1, 2, 2], [2, 1, 2, 1], [1, 2, 1, 2], [2, 2, 1, 1]];
...
describe("duplicateRows and duplicateCols", () => {
  const board = [[1, 2, 2, 1], [1, 1, 1, 2], [1, 2, 2, 1], [2, 1, 1, 2]];
...
describe("isPossibleMove", () => {
  const board = [[0, 0, 2, 1], [0, 0, 0, 0], [0, 0, 2, 1], [0, 0, 1, 2]];
